...
<html>
  <head>
    ...
    <script type="text/javascript">
      $(function () {
        //collect samples of mouse movement and send them to the server periodically
        (function () {
        ...
        //display a ghost of the most recent user's mouse movement
        (function () {
  ...
  <body>
    ...
    You are viewing the most recent visitor's mouse movements.
  </body>
</html>